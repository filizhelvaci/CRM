...
# her bir müşteri için içinde :"Customer Id, recency, frequency, monetary, rfm_segment" değişkenleri olan bir dataframe oluşturuyoruz
...
# rfm dataframe'inin içerisine her bir müşterinin "calculated cltv" değerini 1-100 arasında standartlaştırarak koyunuz.
...
# rfm dataframe'inin içerisine cltv_c_segment adında bir değişken ekliyoruz
# Bu değişken cltv_c değişkenini 3'e bölmüş olsun. C,B,A şeklinde segment isimlendirmesi ile
...
# rfm dataframe'inin içerisine her bir müşterinin 1 ve 3 ay içinde yapması beklenen satış sayılarını ekliyoruz
# (değişken ismi: exp_sales_1_month, exp_sales_3_month)
    ...
    rfm["exp_sales_3_month"] = bgf.predict(12,
                                           ...
                                           rfm['recency_weekly_cltv_p'],
                                           rfm['T_weekly'])
# rfm dataframe'inin içerisine her bir müşterinin expected_average_profit değerini ekliyoruz
# (değişken ismi: expected_average_profit)
    ...
    rfm["expected_average_profit"] = ggf.conditional_expected_average_profit(rfm['frequency'],
                                                                            rfm['monetary_avg'])
# rfm dataframe'inin içerisine her bir müşterinin 6 aylık predicted cltv değerini 1-100 arasında standartlaştırıyoruz
...
# rfm dataframe'inin içerisine cltv_p_segment adında bir değişken ekliyoruz
# Bu değişken cltv_p değişkenini 3'e bölmüş olsun. C,B,A şeklinde segment isimlendirmesi ie
    # cltv_p_segment
